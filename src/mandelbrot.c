...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/09 15:22:58 by xabaudhu          #+#    #+#             */
/*   Updated: 2024/01/09 16:04:51 by xabaudhu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

static t_complex	mandelbrot(t_complex c, t_fractal *fractal, int *check)
{
	t_complex	z;
	t_complex	tmp;
	int			n;
